PROJECT_NAME := Pulumi Slack Resource Provider

PACK             := slack
PACKDIR          := sdk
PROJECT          := github.com/ericogr/pulumi-slack
NODE_MODULE_NAME := @pulumi/slack
NUGET_PKG_NAME   := Pulumi.Slack
...
SCHEMA_FILE     := provider/cmd/pulumi-resource-slack/schema.json
